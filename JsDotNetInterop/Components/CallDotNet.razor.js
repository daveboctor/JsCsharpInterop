...
// Also see:
// https://learn.microsoft.com/en-us/aspnet/core/blazor/javascript-interoperability/import-export-interop?view=aspnetcore-8.0#call-net-from-javascript

export function returnArrayAsync() {
    const id = document.querySelector("#id-input").value;
    DotNet.invokeMethodAsync('JsDotNetInterop', 'GetFormattedSerial', id)
        .then(data => {
